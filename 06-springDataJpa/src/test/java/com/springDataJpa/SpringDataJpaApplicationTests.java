...
//		List<Student> guardianName = studentRepository.findByGuardianName("john");
//		for (Student student : guardianName) {
//			System.out.println(student);
//		}
    }
    ...
    @Test
    void getStudentAge() {
//        Iterable<Student> studentAgeList = studentRepository.findByAgeGreaterThan(18);
//        for (Student student : studentAgeList) {
//            log.info(student.toString());
//        }
        Iterable<Student> studentAgeList = studentRepository.findByAgeGreaterThanAndStudentName(18,"anitha");
        System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
